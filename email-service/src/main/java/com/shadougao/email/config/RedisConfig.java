...
//        template.setHashKeySerializer(fastJsonRedisSerializer);
    ...
    public RedisMessageListenerContainer listenerContainer(RedisConnectionFactory factory,
        ...
        container.addMessageListener(messageListenerAdapter, new PatternTopic(executeChannel));
     ...
     * 监听频道回调
     *
     * @param redisChannelListenerExecute
     * @return
     */
    @Bean
    ...
    public Map<Integer, Method> redisListenerMap() {
        ...
        //TODO 扫描包名暂时写死
        Set<Class<?>> classes = ClassUtil.scanPackageByAnnotation("com.shadougao.email.listener", RedisChannelListener.class);
