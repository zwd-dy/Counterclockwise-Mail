...
public class SendMailExecute implements Runnable {
     ...
     */
    public static void sendMessage(MimeMessage message, MimeMultipart mixed, Transport transport) throws MessagingException {
        // 发送完整消息
     ...
     * @throws MessagingException
     */
    public static MimeMessage constructMessage(Session session, Mail mail) throws MessagingException {
     ...
     * @throws MessagingException
     */
    public static List<BodyPart> constructImgBody(List<String> ids, MailFileService fileService) throws MessagingException {
     ...
     * @throws MessagingException
     */
    public static BodyPart constructTextBody(String mailContent) throws MessagingException {
        // 创建文本部分
     ...
     * @throws MessagingException
     */
    public static MimeMultipart constructRelatedMultipart(String mailContent, MailFileService fileService) throws MessagingException {
     ...
     */
    public static List<BodyPart> constructFileBody(String[] fileIds, MailFileService fileService) throws MessagingException, UnsupportedEncodingException {
     ...
     * @return
     */
    public static Map<String, Object> replaceAllContentByTagSrc(String mailContent) {
     ...
     * @throws MessagingException
     */
    public static MimeBodyPart constructContentBody(String mailContent, MailFileService fileService) throws MessagingException {
    ...
    public static void addBodyPart(MimeMultipart multipart, List<BodyPart> bodyPart) {
        try {
